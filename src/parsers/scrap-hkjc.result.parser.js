...
LEAGUES.forEach(league => {
  ...
  YEARS[league].forEach(year => {
    ...
    const dir = `./../../data/raw/${league}/${folder}`;
    const outDir = `./../../data/processed/${league}/${folder}`;

    const getOddsPortalDetails = () => {
      const matches = JSON.parse(fs.readFileSync(`./../../data/raw/${league}/odds/oddsportal-parsed.json`));
